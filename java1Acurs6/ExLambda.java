public class ExLambda {
    public static void main(String [] args) {
        Predicat p1 = (x) -> x>3;
        Predicat p2 = x -> x>6; // pot sa omit parantezele pt un sg parametru fara tip
        Predicat p3 = (int x) -> x>7;
        Predicat p4 = x -> {return x>4;};
        Predicat p5 = x -> {return x>=6 && x<=10;};
        Predicat p6 = x -> false;
    ...
    public static void metoda(Functie f,int a,int b) {
        ...
        //merge pt orice interfata functionala data ca param
    }
    
    //Met statica: NumeClasa::numeMetoda
    //Met instanta: instanta::numeMetoda
