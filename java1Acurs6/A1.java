public class A1{ //A1 = clasa top-level
    ...
    public class A2{
        //clasa A2 este o clasa inner non-statica pt clasa A1
        //clasa A1 este clasa outer pt clasa A2
        //clasa A2 poate fi si ea outer daca are in intrior declarata alta clasa inner
        int x;
        int z;
        public void m1() {
            this.x = 5;
    ...
    public static class A3 {
        // clasa A3 este clasa inner statica pentru clasa A1
        // clasa A1 este clasa outer pt clasa A3
        public void m2() {
            y = 10;
            //x = 5; -> x este non-static, deci nu il pot fol in inner statica
        }
    }
}